...
powershell -Command Import-Certificate -FilePath "GoDaddy_Root.cer" -CertStoreLocation Cert:\LocalMachine\Root
powershell -Command Import-Certificate -FilePath "GlobalSign_Root.cer" -CertStoreLocation Cert:\LocalMachine\Root
pause
